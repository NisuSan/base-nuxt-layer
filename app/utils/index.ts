export function getJoiMessagesByLocale(locale: Exclude<Layer.JoiLocales, 'custom'>, validator: Layer.InputValidators) {
  const locales = {
    ukUA: {
      ...
      validators: {
        'string-cyrillic': {
          'string.pattern.base': 'Це поле повинно містити лише кириличні літери, пробіли та апострофи',
        },
    ...
    enEn: {
      ...
      validators: {
        'string-cyrillic': {
          'string.pattern.base': 'This field should contain only Cyrillic letters, spaces, and apostrophes',
        },
